...
// ========================================
// TEACHER-SPECIFIC STUDENT RESULTS
// ========================================

function getTeacherResults(teacherId) {
    ...
    return db.prepare(`SELECT
        ...
        JOIN students
        ON students.id = assessment_results.student_id
        ...
        ORDER BY assessment_results.submitted_at DESC
