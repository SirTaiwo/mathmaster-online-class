...
window.selectGeometryTool = function(tool){
    activeTool = tool;
};
...
window.startParallelTool = function(){
...
function(event){
    ...
    console.log("GEOMETRY MOUSEDOWN:", activeTool, mouseX, mouseY);
...
// ======================
  ...
  // ======================
      ...
      console.log("PERPENDICULAR BRANCH ENTERED");
      ...
      if(perpendicularStart === null){
          ...
          "First point selected. Select second point.";
          ...
          "Reference line selected. Now select point for perpendicular line.";
...
window.startPerpendicularTool = function(){
...
window.startBisectorTool = function(){
...
window.startAngleBisectorTool = function(){
